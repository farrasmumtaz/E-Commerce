...
export default function Keranjang({
  ...
  const totalBarang = keranjang.reduce(
      ...
      <div className="tata-letak-baris">
        <div className="kolom-2">
          {keranjang.length === 0 ? (
            <div className="keranjang-kosong">
              ...
              <button
                className="tombol-utama tombol-lanjut-belanja"
                  ...
                  <div>
                    ...
                    <div className="kontrol-jumlah">
                      <div className="grup-tombol-jumlah">
                        <button
                          className="tombol-jumlah"
                          onClick={() => ubahJumlah(item.id, -1)}
                        >
                          -
                        </button>
                        <span className="tampilan-jumlah">
                          {item.kuantitas}
                        </span>
                        <button
                          className="tombol-jumlah"
                      ...
                      <span className="subtotal-keranjang">
                        Subtotal:{" "}
                        <b>Rp {(item.harga * item.kuantitas).toFixed(2)}</b>
                      </span>
                    </div>
                  </div>
                </div>
        ...
        <div className="kolom-1 kotak-ringkasan">
          ...
          <button
            ...
            onClick={() => pindahHalaman("pembayaran")}
